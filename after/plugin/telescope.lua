...
vim.keymap.set('n', '<leader>ffg', builtin.find_files, { noremap = true })
vim.keymap.set('n', '<leader>ffi', function ()
...
vim.keymap.set('n', '<leader>fh',  builtin.oldfiles, { noremap = true })
